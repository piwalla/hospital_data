...
// Target the WORKING store (V2 Fixed)
...
async function main() {
    console.log(`--- Populating Store (V2 Fixed): ${STORE_NAME} using @google/genai ---`);
    ...
    for (const item of filesToUpload) {
        ...
        try {
            ...
            console.log("Success! Resp:", JSON.stringify(resp, null, 2));
